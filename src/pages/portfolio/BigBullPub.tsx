...
const images = [
  "https://res.cloudinary.com/djnyc9yqk/image/upload/v1753782809/v2-_1_j3uljq.jpg",
];
    ...
    <div className="w-full overflow-x-hidden">
      ...
      <section className="relative h-screen w-full">
        <motion.img
          ...
          src="https://res.cloudinary.com/djnyc9yqk/image/upload/v1753782808/v1-_1_ni2obk.jpg"
          alt="Cover"
