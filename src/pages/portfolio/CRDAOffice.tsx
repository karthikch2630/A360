...
const images = [
  "https://res.cloudinary.com/djnyc9yqk/image/upload/v1753783214/SCENE-02_mqn53z.jpg",
];
    ...
    <div className="w-full overflow-x-hidden">
      ...
      <section className="relative h-screen w-full">
        <motion.img
          ...
          src="https://res.cloudinary.com/djnyc9yqk/image/upload/v1753783217/SCENE-04_svfvwl.jpg"
          alt="Cover"
